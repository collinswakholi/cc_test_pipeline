...
data_path = 'Data/Walls/Results'
# data_path = 'Data/Backgrounds/Results'
search_str = 'With_GC_WB_CC_Results_2Deg_nn' # repeat for 'With_FFC_GC_CC_Results_', 'With_FFC_WB_CC_Results_', 'With_CC_Results_', 'With_FFC_CC_Results_', 'With_FFC_GC_WB_CC_Results_'

# data_path = 'Data/Walls'
# search_str = ''
...
log_(f"Saving all metrics to '{os.path.join(data_path, save_str +'_All_Metrics.xlsx')}'", 'green', 'bold')
ALL_METRICS_PD.to_excel(os.path.join(data_path, save_str + '_All_Metrics.xlsx'), index=False, float_format='%.12f')

log_(f"Saving summary metrics to '{os.path.join(data_path, save_str + '_Summary_Metrics.xlsx')}'", 'green', 'bold')
SUMMARY_METRICS_PD.to_excel(os.path.join(data_path, save_str + '_Summary_Metrics.xlsx'), index=False, float_format='%.12f')

log_(f"Saving all metrics to '{os.path.join(data_path, save_str +'_All_Metrics_val.xlsx')}'", 'green', 'bold')
ALL_METRICS_VAL_PD.to_excel(os.path.join(data_path, save_str + '_All_Metrics_val.xlsx'), index=False, float_format='%.12f')  

log_(f"Saving summary metrics to '{os.path.join(data_path, save_str + '_Summary_Metrics_val.xlsx')}'", 'green', 'bold') 
SUMMARY_METRICS_VAL_PD.to_excel(os.path.join(data_path, save_str + '_Summary_Metrics_val.xlsx'), index=False, float_format='%.12f')

log_(f"Saving charts to '{os.path.join(data_path, save_str + '_Charts.xlsx')}'", 'green', 'bold')
ALL_CHARTS_PD.to_excel(os.path.join(data_path, save_str + '_Charts.xlsx'), index=False, float_format='%.12f')
