...
SEQUENCES_ = [
    ...
    [True, False, True, True, True],  # sequence 2
    [True, True, False, True, True],  # sequence 3
    [True, False, False, True, True],  # sequence 4
    [False, False, False, True, True],  # sequence 5
]
...
color_method = 'conv'  # 'ours' or 'conv'
...
def process_folder(f_):
    ...
    matched_folder = match_keywords(f_, FOCUS_ON, threshold=0.9)
